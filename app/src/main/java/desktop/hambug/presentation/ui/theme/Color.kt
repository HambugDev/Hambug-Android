...
val HambugWhite = Color(0xFFFAFAF9)
...
val RemoveRed = Color(0xFFF65555)
val FABRed = Color(0xFFE39280)
val SnackbarBg = Color(0xFFFFEDE8)
val SnackbarText = Color(0xFFEC6D55)
